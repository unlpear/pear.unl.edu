...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_LDAP | Docs for page Exception.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/UNL/LDAP/Exception.php</h2>
...
<p class="short-description">This file contains a class for handling UNL_LDAP exceptions</p>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_LDAP/UNL_LDAP_Exception.php">UNL_LDAP_Exception</a>
					</td>
					<td>
