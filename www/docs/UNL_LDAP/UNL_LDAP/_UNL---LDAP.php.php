...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_LDAP | Docs for page LDAP.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/UNL/LDAP.php</h2>
...
<p class="short-description">This file contains a class for operating with the UNL LDAP directory.</p>
<div class="description"><p>PHP version 5</p><p>$Id$</p></div>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_LDAP/UNL_LDAP.php">UNL_LDAP</a>
					</td>
					<td>
	...
	<div>
		<span class="include-title">
			...
			(<span class="include-name"><a href="../UNL_LDAP/_UNL---LDAP---Exception.php.php">'UNL/LDAP/Exception.php'</a></span>)
