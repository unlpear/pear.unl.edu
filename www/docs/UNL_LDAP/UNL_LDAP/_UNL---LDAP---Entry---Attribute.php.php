...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_LDAP | Docs for page Attribute.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/UNL/LDAP/Entry/Attribute.php</h2>
...
<p class="short-description">LDAP attribute object</p>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_LDAP/UNL_LDAP_Entry_Attribute.php">UNL_LDAP_Entry_Attribute</a>
					</td>
					<td>
