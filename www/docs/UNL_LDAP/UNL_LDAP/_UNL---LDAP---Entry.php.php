...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_LDAP | Docs for page Entry.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/UNL/LDAP/Entry.php</h2>
...
<p class="short-description">LDAP entry class.</p>
<div class="description"><p>PHP version 5</p><p>$Id$</p></div>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_LDAP/UNL_LDAP_Entry.php">UNL_LDAP_Entry</a>
					</td>
					<td>
	...
	<div>
		<span class="include-title">
			...
			(<span class="include-name"><a href="../UNL_LDAP/_UNL---LDAP---Entry---Attribute.php.php">'UNL/LDAP/Entry/Attribute.php'</a></span>)
