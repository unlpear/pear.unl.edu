...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_LDAP | Docs for page Result.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/UNL/LDAP/Result.php</h2>
...
<div class="description"><p>PHP version 5</p><p>$Id$</p></div>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_LDAP/UNL_LDAP_Result.php">UNL_LDAP_Result</a>
					</td>
					<td>
											LDAP result record
										</td>
	...
	<div>
		<span class="include-title">
			...
			(<span class="include-name"><a href="../UNL_LDAP/_UNL---LDAP---Entry.php.php">'UNL/LDAP/Entry.php'</a></span>)
