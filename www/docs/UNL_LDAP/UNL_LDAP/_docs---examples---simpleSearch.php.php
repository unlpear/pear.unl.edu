...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_LDAP | Docs for page simpleSearch.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/docs/examples/simpleSearch.php</h2>
...
<p class="short-description">This file conducts a simple ldap search</p>
