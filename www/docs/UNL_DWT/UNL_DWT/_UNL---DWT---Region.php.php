...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_DWT | Docs for page Region.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/UNL/DWT/Region.php</h2>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_DWT/UNL_DWT_Region.php">UNL_DWT_Region</a>
					</td>
					<td>
