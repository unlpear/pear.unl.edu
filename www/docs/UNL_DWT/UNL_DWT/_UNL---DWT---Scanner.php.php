...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_DWT | Docs for page Scanner.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/UNL/DWT/Scanner.php</h2>
...
<p class="short-description">Handles scanning a dwt file for regions.</p>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_DWT/UNL_DWT_Scanner.php">UNL_DWT_Scanner</a>
					</td>
					<td>
