...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_DWT | Docs for page Generator.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/UNL/DWT/Generator.php</h2>
...
<p class="short-description">The Generator is used to generate UNL_DWT classes and cached .tpl files from  Dreamweaver Template files.</p>
<div class="description"><p>PHP version 5</p></div>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_DWT/UNL_DWT_Generator.php">UNL_DWT_Generator</a>
					</td>
					<td>
	...
	<div>
		<span class="include-title">
			...
			(<span class="include-name"><a href="../UNL_DWT/_UNL---DWT.php.php">'UNL/DWT.php'</a></span>)
...
<div class="oddrow">
	...
	<div>
		<span class="include-title">
			<span class="include-type">require_once</span>
			(<span class="include-name"><a href="../UNL_DWT/_UNL---DWT---Region.php.php">'UNL/DWT/Region.php'</a></span>)
