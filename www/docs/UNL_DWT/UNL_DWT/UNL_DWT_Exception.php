...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_DWT | Docs For Class UNL_DWT_Exception</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="class-name">Class UNL_DWT_Exception</h2>
...
<p class="short-description">exception used by the UNL_DWT class</p>
	<ul class="tags">
		...
		<p class="notes">
			Located in <a class="field" href="_UNL---DWT.php.php">/UNL/DWT.php</a> (line <span class="field">249</span>)
		</p>
		
				
		<pre>Exception
   |
   --UNL_DWT_Exception</pre>
