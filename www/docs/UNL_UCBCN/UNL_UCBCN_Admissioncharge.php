...
<p class="short-description">ORM for a record within the database.</p>
		<p class="notes">
			Located in <a class="field" href="_UCBCN---Admissioncharge.php.php">/UCBCN/Admissioncharge.php</a> (line <span class="field">17</span>)
		</p>
   ...
   --UNL_UCBCN_Admissioncharge</pre>
	...
	<div class="info-box">
		...
		<div class="info-box-body">
			<div class="var-summary">
					...
					<a href="#$admissioninfogroup_id" title="details" class="var-name">$admissioninfogroup_id</a>
				</div>
																<div class="var-title">
					<span class="var-type">mixed</span>
					...
					<a href="#$id" title="details" class="var-name">$id</a>
																...
																<div class="var-title">
					<span class="var-type">mixed</span>
					<a href="#$price" title="details" class="var-name">$price</a>
				</div>
																<div class="var-title">
					<span class="var-type">mixed</span>
	...
	<div class="info-box">
		...
		<div class="info-box-body">
			<a name="var$admissioninfogroup_id" id="$admissioninfogroup_id"><!-- --></A>
<div class="evenrow">
	...
	<div class="var-header">
		<span class="var-title">
			...
			<span class="var-name">$__table</span>
			 = <span class="var-default"> 'admissioncharge'</span>			(line <span class="line-number">22</span>)
		</span>
	</div>
...
<div class="oddrow">
	...
	<div class="method-header">
		<span class="method-title">staticGet</span> (line <span class="line-number">29</span>)
	</div> 
	...
	<p class="notes" id="credit">
		Documentation generated on Mon, 22 Jan 2007 17:10:47 -0600 by <a href="http://www.phpdoc.org" target="_blank">phpDocumentor 1.3.1</a>
	</p>
	</div>
<?php
