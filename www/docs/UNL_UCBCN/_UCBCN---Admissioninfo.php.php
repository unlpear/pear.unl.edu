...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN | Docs for page Admissioninfo.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/UCBCN/Admissioninfo.php</h2>
...
<p class="short-description">Table Definition for admissioninfo</p>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_UCBCN/UNL_UCBCN_Admissioninfo.php">UNL_UCBCN_Admissioninfo</a>
					</td>
					<td>
