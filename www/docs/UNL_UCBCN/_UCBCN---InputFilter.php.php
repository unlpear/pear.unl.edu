...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN | Docs for page InputFilter.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/UCBCN/InputFilter.php</h2>
...
<p class="short-description">A generic Input Filter interface.</p>
	<ul class="tags">
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_UCBCN/UNL_UCBCN_InputFilter.php">UNL_UCBCN_InputFilter</a>
					</td>
					<td>
	...
	<div class="info-box">
		...
		<div class="info-box-body">	
			<a name="_UNL/UCBCN/InputFilterInterface_php"><!-- --></a>
<div class="oddrow">
	
	<div>
		<span class="include-title">
			<span class="include-type">require_once</span>
			(<span class="include-name">'UNL/UCBCN/InputFilterInterface.php'</span>)
