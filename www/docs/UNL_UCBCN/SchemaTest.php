...
<p class="short-description">This class can be used by PHPUnit to test the UNL_UCBCN database schema.</p>
   ...
   --SchemaTest</pre>
	...
	<div class="info-box">
		...
		<div class="info-box-body">
			<div class="var-summary">
					...
					<a href="#$backup_extension" title="details" class="var-name">$backup_extension</a>
				</div>
																<div class="var-title">
					<span class="var-type">mixed</span>
					<a href="#$database" title="details" class="var-name">$database</a>
																...
																<div class="var-title">
					<span class="var-type">mixed</span>
					<a href="#$driver_input_file" title="details" class="var-name">$driver_input_file</a>
				</div>
																<div class="var-title">
					<span class="var-type">mixed</span>
	...
	<div class="info-box">
		...
		<div class="info-box-body">
			<a name="var$backup_extension" id="$backup_extension"><!-- --></A>
<div class="oddrow">
...
<a name="var$driver_input_file" id="$driver_input_file"><!-- --></A>
<div class="oddrow">
