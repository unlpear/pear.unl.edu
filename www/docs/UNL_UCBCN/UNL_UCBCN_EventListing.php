...
<p class="short-description">This class holds all the events for the list.</p>
		<p class="notes">
			Located in <a class="field" href="_UCBCN---EventListing.php.php">/UCBCN/EventListing.php</a> (line <span class="field">16</span>)
		</p>
		...
		<div class="info-box-body">			
			<div class="method-summary">
										...
										<a href="#constructUpcomingEventList" title="details" class="method-name">constructUpcomingEventList</a>
											(<span class="var-type">unknown_type</span>&nbsp;<span class="var-name">$options</span>)
									</div>
								</div>
		</div>
	</div>		
...
<div class="evenrow">
	...
	<div class="method-header">
		<span class="method-title">constructDayEventInstanceList</span> (line <span class="line-number">60</span>)
	</div> 
...
<div class="oddrow">
	...
	<div class="method-header">
		<span class="method-title">constructOngoingEventList</span> (line <span class="line-number">135</span>)
	</div> 
...
<div class="evenrow">
	...
	<div class="method-header">
		<span class="method-title">constructUpcomingEventList</span> (line <span class="line-number">96</span>)
	</div> 
