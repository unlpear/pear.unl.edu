...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN | Docs for page EventListing.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/UCBCN/EventListing.php</h2>
...
<p class="short-description">Object related to a list ov events.</p>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_UCBCN/UNL_UCBCN_EventListing.php">UNL_UCBCN_EventListing</a>
					</td>
					<td>
