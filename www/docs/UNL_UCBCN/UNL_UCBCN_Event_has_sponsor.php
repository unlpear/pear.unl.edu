...
<p class="short-description">ORM for a record within the database.</p>
		<p class="notes">
			Located in <a class="field" href="_UCBCN---Event_has_sponsor.php.php">/UCBCN/Event_has_sponsor.php</a> (line <span class="field">16</span>)
		</p>
	...
	<div class="var-header">
		<span class="var-title">
			...
			<span class="var-name">$__table</span>
			 = <span class="var-default"> 'event_has_sponsor'</span>			(line <span class="line-number">21</span>)
		</span>
	</div>
...
<div class="oddrow">
	...
	<p class="notes" id="credit">
		Documentation generated on Mon, 22 Jan 2007 17:11:02 -0600 by <a href="http://www.phpdoc.org" target="_blank">phpDocumentor 1.3.1</a>
	</p>
	</div>
<?php
