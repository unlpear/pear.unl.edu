...
<p class="short-description">ORM for a record within the database.</p>
		<p class="notes">
			Located in <a class="field" href="_UCBCN---Document.php.php">/UCBCN/Document.php</a> (line <span class="field">16</span>)
		</p>
	...
	<div class="var-header">
		<span class="var-title">
			...
			<span class="var-name">$__table</span>
			 = <span class="var-default"> 'document'</span>			(line <span class="line-number">21</span>)
		</span>
	</div>
