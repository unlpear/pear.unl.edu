...
<p class="short-description">ORM for a record within the database.</p>
		<p class="notes">
			Located in <a class="field" href="_UCBCN---Sponsor.php.php">/UCBCN/Sponsor.php</a> (line <span class="field">15</span>)
		</p>
		...
		<div class="info-box-body">
			<div class="var-summary">
					...
					<a href="#$name" title="details" class="var-name">$name</a>
																...
																<div class="var-title">
					<span class="var-type">mixed</span>
					<a href="#$sponsortype" title="details" class="var-name">$sponsortype</a>
				</div>
																<div class="var-title">
					<span class="var-type">mixed</span>
	...
	<div class="var-header">
		<span class="var-title">
			...
			<span class="var-name">$fb_linkDisplayFields</span>
			 = <span class="var-default">array('name')</span>			(line <span class="line-number">33</span>)
		</span>
	</div>
...
<a name="var$sponsortype" id="$sponsortype"><!-- --></A>
<div class="oddrow">
	...
	<div class="var-header">
		<span class="var-title">
			...
			<span class="var-name">$__table</span>
			 = <span class="var-default"> 'sponsor'</span>			(line <span class="line-number">20</span>)
		</span>
	</div>
...
<div class="oddrow">
	...
	<div class="method-header">
		<span class="method-title">staticGet</span> (line <span class="line-number">28</span>)
	</div> 
	...
	<p class="notes" id="credit">
		Documentation generated on Mon, 22 Jan 2007 17:11:11 -0600 by <a href="http://www.phpdoc.org" target="_blank">phpDocumentor 1.3.1</a>
	</p>
	</div>
<?php
