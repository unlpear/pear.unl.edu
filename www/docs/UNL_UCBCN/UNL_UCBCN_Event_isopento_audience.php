...
<p class="short-description">ORM for a record within the database.</p>
		<p class="notes">
			Located in <a class="field" href="_UCBCN---Event_isopento_audience.php.php">/UCBCN/Event_isopento_audience.php</a> (line <span class="field">16</span>)
		</p>
   ...
   --UNL_UCBCN_Event_isopento_audience</pre>
	...
	<div class="info-box">
		...
		<div class="info-box-body">
			<div class="var-summary">
					...
					<a href="#$audience_id" title="details" class="var-name">$audience_id</a>
				</div>
																<div class="var-title">
					<span class="var-type">mixed</span>
	...
	<div class="info-box">
		...
		<div class="info-box-body">
			<a name="var$audience_id" id="$audience_id"><!-- --></A>
<div class="oddrow">
	...
	<div class="var-header">
		<span class="var-title">
			...
			<span class="var-name">$__table</span>
			 = <span class="var-default"> 'event_isopento_audience'</span>			(line <span class="line-number">21</span>)
		</span>
	</div>
