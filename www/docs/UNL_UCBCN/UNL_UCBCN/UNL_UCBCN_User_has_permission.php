...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN | Docs For Class UNL_UCBCN_User_has_permission</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="class-name">Class UNL_UCBCN_User_has_permission</h2>
...
<p class="short-description">ORM for a record within the database.</p>
	<ul class="tags">
		...
		<p class="notes">
			Located in <a class="field" href="_UNL---UCBCN---User_has_permission.php.php">/UNL/UCBCN/User_has_permission.php</a> (line <span class="field">28</span>)
		</p>
		
				
		<pre>DB_DataObject
   |
   --UNL_UCBCN_User_has_permission</pre>
		...
		<div class="info-box-body">
			<div class="var-summary">
					...
					<a href="#var_id" title="details" class="var-name">$id</a>
																...
																<div class="var-title">
					<span class="var-type">mixed</span>
					<a href="#var_permission_id" title="details" class="var-name">$permission_id</a>
				</div>
																<div class="var-title">
					<span class="var-type">mixed</span>
					<a href="#var_user_uid" title="details" class="var-name">$user_uid</a>
				</div>
																<div class="var-title">
					<span class="var-type">mixed</span>
	...
	<div class="var-header">
		<span class="var-title">
			...
			<span class="var-name">$fb_excludeFromAutoRules</span>
			 = <span class="var-default">array('permission_id','user_uid','calendar_id')</span>			(line <span class="line-number">45</span>)
		</span>
	</div>
	...
	<div class="var-header">
		<span class="var-title">
			...
			<span class="var-name">$fb_fieldLabels</span>
			 = <span class="var-default">array('calendar_id'=&gt;'Calendar')</span>			(line <span class="line-number">46</span>)
		</span>
	</div>
...
<a name="var_permission_id" id="var_permission_id"><!-- --></a>
<div class="evenrow">

	<div class="var-header">
		<span class="var-title">
			<span class="var-type">mixed</span>
			<span class="var-name">$permission_id</span>
...
<a name="var_user_uid" id="var_user_uid"><!-- --></a>
<div class="oddrow">

	<div class="var-header">
		<span class="var-title">
			<span class="var-type">mixed</span>
			<span class="var-name">$user_uid</span>
	...
	<div class="var-header">
		<span class="var-title">
			...
			<span class="var-name">$__table</span>
			 = <span class="var-default"> 'user_has_permission'</span>			(line <span class="line-number">33</span>)
		</span>
	</div>
...
<div class="oddrow">
	...
	<div class="method-header">
		<span class="method-title">insert</span> (line <span class="line-number">77</span>)
	</div> 
...
<div class="evenrow">
	...
	<div class="method-header">
		<span class="method-title">keys</span> (line <span class="line-number">58</span>)
	</div> 
...
<div class="oddrow">
	...
	<div class="method-header">
		<span class="method-title">links</span> (line <span class="line-number">70</span>)
	</div> 
...
<div class="evenrow">
	...
	<div class="method-header">
		<span class="method-title">sequenceKey</span> (line <span class="line-number">65</span>)
	</div> 
...
<div class="evenrow">
	...
	<div class="method-header">
		<span class="method-title">table</span> (line <span class="line-number">48</span>)
	</div> 
