...
<div class="description"><p>UNL_UCBCN_Error is a quick wrapper around pear error, so you can distinguish the  error code source.</p><p>PHP version 5</p></div>
	<ul class="tags">
...
<p class="short-description">Require the PEAR class to extend it for error handling.</p>
	...
	<p class="notes" id="credit">
		Documentation generated on Thu, 19 Feb 2009 13:35:38 -0600 by <a href="http://www.phpdoc.org" target="_blank">phpDocumentor 1.4.2</a>
	</p>
	</div>
<?php
