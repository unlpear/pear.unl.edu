...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN | Docs for page Event_has_eventtype.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/UCBCN/Event_has_eventtype.php</h2>
...
<p class="short-description">Table Definition for event_has_eventtype</p>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_UCBCN/UNL_UCBCN_Event_has_eventtype.php">UNL_UCBCN_Event_has_eventtype</a>
					</td>
					<td>
