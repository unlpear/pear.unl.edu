...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN | Docs for page Event.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/UCBCN/Event.php</h2>
...
<p class="short-description">Table Definition for event</p>
<div class="description"><p>PHP version 5</p></div>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_UCBCN/UNL_UCBCN_Event.php">UNL_UCBCN_Event</a>
					</td>
					<td>
	...
	<!-- ========== Info from phpDoc block ========= -->
<p class="short-description">Require DB_DataObject to extend from it, as well as the backend UNL_UCBCN.</p>
