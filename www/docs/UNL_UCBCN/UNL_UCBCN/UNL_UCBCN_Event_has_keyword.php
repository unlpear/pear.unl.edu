...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN | Docs For Class UNL_UCBCN_Event_has_keyword</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="class-name">Class UNL_UCBCN_Event_has_keyword</h2>
...
<p class="short-description">ORM for a record within the database.</p>
	<ul class="tags">
		...
		<p class="notes">
			Located in <a class="field" href="_UNL---UCBCN---Event_has_keyword.php.php">/UNL/UCBCN/Event_has_keyword.php</a> (line <span class="field">28</span>)
		</p>
		
				
		<pre>DB_DataObject
   |
   --UNL_UCBCN_Event_has_keyword</pre>
		...
		<div class="info-box-body">
			<div class="var-summary">
					...
					<a href="#var_id" title="details" class="var-name">$id</a>
																...
																<div class="var-title">
					<span class="var-type">mixed</span>
					<a href="#var_keyword_id" title="details" class="var-name">$keyword_id</a>
				</div>
																<div class="var-title">
					<span class="var-type">mixed</span>
...
<a name="var_keyword_id" id="var_keyword_id"><!-- --></a>
<div class="evenrow">

	<div class="var-header">
		<span class="var-title">
			<span class="var-type">mixed</span>
			<span class="var-name">$keyword_id</span>
	...
	<div class="var-header">
		<span class="var-title">
			...
			<span class="var-name">$__table</span>
			 = <span class="var-default"> 'event_has_keyword'</span>			(line <span class="line-number">33</span>)
		</span>
	</div>
...
<div class="evenrow">
	...
	<div class="method-header">
		<span class="method-title">keys</span> (line <span class="line-number">53</span>)
	</div> 
...
<div class="oddrow">
	...
	<div class="method-header">
		<span class="method-title">links</span> (line <span class="line-number">65</span>)
	</div> 
...
<div class="evenrow">
	...
	<div class="method-header">
		<span class="method-title">sequenceKey</span> (line <span class="line-number">60</span>)
	</div> 
