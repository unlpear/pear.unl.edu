...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN | Docs for page Calendar.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/UCBCN/Calendar.php</h2>
...
<p class="short-description">Details related to a calendar within the UNL Event Publisher system.</p>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_UCBCN/UNL_UCBCN_Calendar.php">UNL_UCBCN_Calendar</a>
					</td>
					<td>
