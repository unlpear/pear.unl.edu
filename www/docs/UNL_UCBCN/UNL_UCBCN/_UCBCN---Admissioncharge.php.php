...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN | Docs for page Admissioncharge.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/UCBCN/Admissioncharge.php</h2>
...
<p class="short-description">Table Definition for admissioncharge</p>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_UCBCN/UNL_UCBCN_Admissioncharge.php">UNL_UCBCN_Admissioncharge</a>
					</td>
					<td>
