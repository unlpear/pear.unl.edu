...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN | Docs for page Account.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/UCBCN/Account.php</h2>
...
<p class="short-description">Table Definition for account</p>
<div class="description"><p>PHP version 5</p></div>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_UCBCN/UNL_UCBCN_Account.php">UNL_UCBCN_Account</a>
					</td>
					<td>
											UNL_UCBCN_Account object stores information for an account record within  the database.
										</td>
				</tr>
							</table>
		</div>
	...
	<!-- ========== Info from phpDoc block ========= -->
<p class="short-description">Extend DB_DataObject</p>
	...
	<p class="notes" id="credit">
		Documentation generated on Thu, 19 Feb 2009 13:35:36 -0600 by <a href="http://www.phpdoc.org" target="_blank">phpDocumentor 1.4.2</a>
	</p>
	</div>
<?php
