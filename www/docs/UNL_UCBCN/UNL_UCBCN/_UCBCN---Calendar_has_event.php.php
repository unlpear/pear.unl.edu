...
?>
			<div class="page-body">			
<h2 class="file-name">/UCBCN/Calendar_has_event.php</h2>
...
<div class="oddrow">
	...
	<div>
		<span class="include-title">
			<span class="include-type">require_once</span>
			(<span class="include-name">'UNL/UCBCN/Subscription.php'</span>)
...
<p class="short-description">UNL_UCBCN_Subscription is needed to determine which subscribed calendars to update.</p>
	...
	<p class="notes" id="credit">
		Documentation generated on Thu, 19 Feb 2009 13:35:37 -0600 by <a href="http://www.phpdoc.org" target="_blank">phpDocumentor 1.4.2</a>
	</p>
	</div>
<?php
