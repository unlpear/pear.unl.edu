...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN | Docs for page Calendar_has_event.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/UNL/UCBCN/Calendar_has_event.php</h2>
...
<p class="short-description">Table definition, and processing functions for calendar_has_event</p>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_UCBCN/UNL_UCBCN_Calendar_has_event.php">UNL_UCBCN_Calendar_has_event</a>
					</td>
					<td>
...
<div class="evenrow">
	...
	<!-- ========== Info from phpDoc block ========= -->
<p class="short-description">Backend is required for UNL_UCBCN::factory</p>
...
<div class="oddrow">
	...
	<div>
		<span class="include-title">
			<span class="include-type">require_once</span>
			(<span class="include-name"><a href="../UNL_UCBCN/_UNL---UCBCN---Subscription.php.php">'UNL/UCBCN/Subscription.php'</a></span>)
			(line <span class="line-number">28</span>)
		</span>
	</div>

	<!-- ========== Info from phpDoc block ========= -->
<p class="short-description">UNL_UCBCN_Subscription is needed to determine which subscribed calendars to update.</p>
