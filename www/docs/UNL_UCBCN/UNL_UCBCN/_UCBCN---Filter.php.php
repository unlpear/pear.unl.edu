...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN | Docs for page Filter.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/UCBCN/Filter.php</h2>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_UCBCN/UNL_UCBCN_Filter.php">UNL_UCBCN_Filter</a>
					</td>
					<td>
