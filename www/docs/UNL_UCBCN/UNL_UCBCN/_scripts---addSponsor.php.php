...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN | Docs for page addSponsor.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/scripts/addSponsor.php</h2>
...
<p class="short-description">Sample script for adding sponsors.</p>
