...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN | Docs For Class UNL_UCBCN_Webcastlink</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="class-name">Class UNL_UCBCN_Webcastlink</h2>
...
<p class="short-description">ORM for a record within the database.</p>
	<ul class="tags">
		...
		<p class="notes">
			Located in <a class="field" href="_UNL---UCBCN---Webcastlink.php.php">/UNL/UCBCN/Webcastlink.php</a> (line <span class="field">28</span>)
		</p>
		
				
		<pre>DB_DataObject
   |
   --UNL_UCBCN_Webcastlink</pre>
		...
		<div class="info-box-body">
			<div class="var-summary">
					...
					<a href="#var_id" title="details" class="var-name">$id</a>
																...
																<div class="var-title">
					<span class="var-type">mixed</span>
					<a href="#var_related" title="details" class="var-name">$related</a>
				</div>
																<div class="var-title">
					<span class="var-type">mixed</span>
					<a href="#var_sequencenumber" title="details" class="var-name">$sequencenumber</a>
				</div>
																<div class="var-title">
					<span class="var-type">mixed</span>
					<a href="#var_url" title="details" class="var-name">$url</a>
																...
																<div class="var-title">
					<span class="var-type">mixed</span>
					<a href="#var_webcast_id" title="details" class="var-name">$webcast_id</a>
				</div>
																<div class="var-title">
					<span class="var-type">mixed</span>
...
<a name="var_related" id="var_related"><!-- --></a>
<div class="evenrow">

	<div class="var-header">
		<span class="var-title">
			<span class="var-type">mixed</span>
			<span class="var-name">$related</span>
...
<a name="var_sequencenumber" id="var_sequencenumber"><!-- --></a>
<div class="oddrow">

	<div class="var-header">
		<span class="var-title">
			<span class="var-type">mixed</span>
			<span class="var-name">$sequencenumber</span>
...
<a name="var_webcast_id" id="var_webcast_id"><!-- --></a>
<div class="oddrow">

	<div class="var-header">
		<span class="var-title">
			<span class="var-type">mixed</span>
			<span class="var-name">$webcast_id</span>
	...
	<div class="var-header">
		<span class="var-title">
			...
			<span class="var-name">$__table</span>
			 = <span class="var-default"> 'webcastlink'</span>			(line <span class="line-number">33</span>)
		</span>
	</div>
...
<div class="oddrow">
	...
	<div class="method-header">
		<span class="method-title">keys</span> (line <span class="line-number">57</span>)
	</div> 
...
<div class="evenrow">
	...
	<div class="method-header">
		<span class="method-title">links</span> (line <span class="line-number">69</span>)
	</div> 
...
<div class="oddrow">
	...
	<div class="method-header">
		<span class="method-title">sequenceKey</span> (line <span class="line-number">64</span>)
	</div> 
...
<div class="oddrow">
	...
	<div class="method-header">
		<span class="method-title">table</span> (line <span class="line-number">46</span>)
	</div> 
