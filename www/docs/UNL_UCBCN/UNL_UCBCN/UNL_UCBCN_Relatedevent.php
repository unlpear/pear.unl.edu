...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN | Docs For Class UNL_UCBCN_Relatedevent</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="class-name">Class UNL_UCBCN_Relatedevent</h2>
...
<p class="short-description">ORM for a record within the database.</p>
	<ul class="tags">
		...
		<p class="notes">
			Located in <a class="field" href="_UNL---UCBCN---Relatedevent.php.php">/UNL/UCBCN/Relatedevent.php</a> (line <span class="field">28</span>)
		</p>
		
				
		<pre>DB_DataObject
   |
   --UNL_UCBCN_Relatedevent</pre>
		...
		<div class="info-box-body">
			<div class="var-summary">
					...
					<a href="#var_event_id" title="details" class="var-name">$event_id</a>
																...
																<div class="var-title">
					<span class="var-type">mixed</span>
					<a href="#var_related_event_id" title="details" class="var-name">$related_event_id</a>
				</div>
																<div class="var-title">
					<span class="var-type">mixed</span>
					<a href="#var_relationtype" title="details" class="var-name">$relationtype</a>
				</div>
																<div class="var-title">
					<span class="var-type">mixed</span>
...
<a name="var_related_event_id" id="var_related_event_id"><!-- --></a>
<div class="oddrow">

	<div class="var-header">
		<span class="var-title">
			<span class="var-type">mixed</span>
			<span class="var-name">$related_event_id</span>
...
<a name="var_relationtype" id="var_relationtype"><!-- --></a>
<div class="evenrow">

	<div class="var-header">
		<span class="var-title">
			<span class="var-type">mixed</span>
			<span class="var-name">$relationtype</span>
	...
	<div class="var-header">
		<span class="var-title">
			...
			<span class="var-name">$__table</span>
			 = <span class="var-default"> 'relatedevent'</span>			(line <span class="line-number">33</span>)
		</span>
	</div>
...
<div class="evenrow">
	...
	<div class="method-header">
		<span class="method-title">links</span> (line <span class="line-number">53</span>)
	</div> 
...
<div class="oddrow">
	...
	<div class="method-header">
		<span class="method-title">sequenceKey</span> (line <span class="line-number">59</span>)
	</div> 
...
<div class="oddrow">
	...
	<div class="method-header">
		<span class="method-title">table</span> (line <span class="line-number">44</span>)
	</div> 
