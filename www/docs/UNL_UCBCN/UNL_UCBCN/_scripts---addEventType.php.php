...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN | Docs for page addEventType.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/scripts/addEventType.php</h2>
...
<p class="short-description">Sample script for adding event types.</p>
<div class="description"><p>PHP version 5</p></div>
	<ul class="tags">
				<li><span class="field">author:</span> Brian Steere</li>
