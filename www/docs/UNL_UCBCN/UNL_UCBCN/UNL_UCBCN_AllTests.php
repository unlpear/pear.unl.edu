...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN | Docs For Class UNL_UCBCN_AllTests</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="class-name">Class UNL_UCBCN_AllTests</h2>
...
<div class="info-box">
	...
	<div class="info-box-body">
		...
		<p class="notes">
			Located in <a class="field" href="_tests---AllTests.php.php">/tests/AllTests.php</a> (line <span class="field">29</span>)
		</p>
...
<div class="oddrow">
	...
	<div class="method-header">
		<span class="method-title">static method main</span> (line <span class="line-number">36</span>)
	</div> 
...
<div class="evenrow">
	...
	<div class="method-header">
		<span class="method-title">static method suite</span> (line <span class="line-number">47</span>)
	</div> 
	
	<!-- ========== Info from phpDoc block ========= -->
<p class="short-description">Adds the UNL_UCBCNTest suite.</p>
	<ul class="tags">
				<li><span class="field">access:</span> public</li>
			</ul>
