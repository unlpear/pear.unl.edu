...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN | Docs For Class UNL_UCBCN_Admissioncharge</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="class-name">Class UNL_UCBCN_Admissioncharge</h2>
...
<p class="short-description">ORM for a record within the database.</p>
	<ul class="tags">
		...
		<p class="notes">
			Located in <a class="field" href="_UNL---UCBCN---Admissioncharge.php.php">/UNL/UCBCN/Admissioncharge.php</a> (line <span class="field">29</span>)
		</p>
		
				
		<pre>DB_DataObject
   |
   --UNL_UCBCN_Admissioncharge</pre>
	...
	<div class="info-box">
		...
		<div class="info-box-body">
			<div class="var-summary">
					...
					<a href="#var_admissioninfogroup_id" title="details" class="var-name">$admissioninfogroup_id</a>
				</div>
																<div class="var-title">
					<span class="var-type">mixed</span>
					...
					<a href="#var_id" title="details" class="var-name">$id</a>
																...
																<div class="var-title">
					<span class="var-type">mixed</span>
					<a href="#var_price" title="details" class="var-name">$price</a>
				</div>
																<div class="var-title">
					<span class="var-type">mixed</span>
	...
	<div class="info-box">
		...
		<div class="info-box-body">
			<a name="var_admissioninfogroup_id" id="var_admissioninfogroup_id"><!-- --></a>
<div class="oddrow">

	<div class="var-header">
		<span class="var-title">
			<span class="var-type">mixed</span>
			<span class="var-name">$admissioninfogroup_id</span>
...
<a name="var_price" id="var_price"><!-- --></a>
<div class="evenrow">

	<div class="var-header">
		<span class="var-title">
			<span class="var-type">mixed</span>
			<span class="var-name">$price</span>
	...
	<div class="var-header">
		<span class="var-title">
			...
			<span class="var-name">$__table</span>
			 = <span class="var-default"> 'admissioncharge'</span>			(line <span class="line-number">34</span>)
		</span>
	</div>
...
<div class="evenrow">
	...
	<div class="method-header">
		<span class="method-title">keys</span> (line <span class="line-number">56</span>)
	</div> 
...
<div class="oddrow">
	...
	<div class="method-header">
		<span class="method-title">links</span> (line <span class="line-number">68</span>)
	</div> 
...
<div class="evenrow">
	...
	<div class="method-header">
		<span class="method-title">sequenceKey</span> (line <span class="line-number">63</span>)
	</div> 
