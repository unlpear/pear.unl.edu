...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN | Docs for page AllTests.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/tests/AllTests.php</h2>
...
<p class="short-description">Test suite for UNL_UCBCN</p>
<div class="description"><p>PHP versions 5</p></div>
	<ul class="tags">
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_UCBCN/UNL_UCBCN_AllTests.php">UNL_UCBCN_AllTests</a>
					</td>
					<td>
	...
	<div>
		<span class="include-title">
			...
			(<span class="include-name">dirname(__FILE__).'/UNL/UCBCNTest.php'</span>)
...
<div class="evenrow">
	...
	<div>
		<span class="include-title">
			<span class="include-type">require_once</span>
			(<span class="include-name">dirname(__FILE__).'/InstallTest.php'</span>)
...
<div class="evenrow">
	...
	<div>
		<span class="include-title">
			<span class="include-type">require_once</span>
			(<span class="include-name">'PHPUnit/TextUI/TestRunner.php'</span>)
...
<div class="oddrow">
	...
	<div>
		<span class="include-title">
			<span class="include-type">require_once</span>
			(<span class="include-name">dirname(__FILE__).'/UNL/UCBCN/AccountTest.php'</span>)
...
<div class="evenrow">
	...
	<div>
		<span class="include-title">
			<span class="include-type">require_once</span>
			(<span class="include-name">dirname(__FILE__).'/UNL/UCBCN/CalendarTest.php'</span>)
...
<div class="oddrow">
	...
	<div>
		<span class="include-title">
			<span class="include-type">require_once</span>
			(<span class="include-name">dirname(__FILE__).'/UNL/UCBCN/EventInstanceTest.php'</span>)
...
<div class="evenrow">
	...
	<div>
		<span class="include-title">
			<span class="include-type">require_once</span>
			(<span class="include-name">dirname(__FILE__).'/UNL/UCBCN/UserTest.php'</span>)
...
<div class="oddrow">
	...
	<div>
		<span class="include-title">
			<span class="include-type">require_once</span>
			(<span class="include-name">dirname(__FILE__).'/SchemaTest.php'</span>)
...
<div class="evenrow">
	...
	<div>
		<span class="const-title">
			<span class="const-name">PHPUnit_MAIN_METHOD</span> = 'UNL_UCBCN_AllTests::main'
