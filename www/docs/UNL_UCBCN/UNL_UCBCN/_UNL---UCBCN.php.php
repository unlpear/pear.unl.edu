...
?>
			<div class="page-body">			
<h2 class="file-name">/UNL/UCBCN.php</h2>
...
<div class="description"><p>The class facilitates interaction between child objects and the database. It also  contains static functions useful throughout various frontends including  conversion between various formats:     Database &lt;--&gt; iCalendar     Database &lt;--&gt; hCalendar     Database &lt;--&gt; xml conforming to The berkeley xml format.</p><p>It also provides help to frontends that want to display information through a  template system.</p><p>PHP version 5</p></div>
	<ul class="tags">
...
<div class="oddrow">
	...
	<div>
		<span class="include-title">
			<span class="include-type">require_once</span>
			(<span class="include-name"><a href="../UNL_UCBCN/_UNL---UCBCN---Error.php.php">'UNL/UCBCN/Error.php'</a></span>)
