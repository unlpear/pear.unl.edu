...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN | Docs for page Eventdatetime.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/UCBCN/Eventdatetime.php</h2>
...
<p class="short-description">Table Definition for eventdatetime</p>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_UCBCN/UNL_UCBCN_Eventdatetime.php">UNL_UCBCN_Eventdatetime</a>
					</td>
					<td>
