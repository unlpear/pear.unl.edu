...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN | Docs For Class UNL_UCBCN_Event_targets_audience</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="class-name">Class UNL_UCBCN_Event_targets_audience</h2>
...
<p class="short-description">ORM for a record within the database.</p>
	<ul class="tags">
		...
		<p class="notes">
			Located in <a class="field" href="_UNL---UCBCN---Event_targets_audience.php.php">/UNL/UCBCN/Event_targets_audience.php</a> (line <span class="field">28</span>)
		</p>
		
				
		<pre>DB_DataObject
   |
   --UNL_UCBCN_Event_targets_audience</pre>
	...
	<div class="var-header">
		<span class="var-title">
			...
			<span class="var-name">$fb_formHeaderText</span>
			 = <span class="var-default"> 'Target Audience'</span>			(line <span class="line-number">48</span>)
		</span>
	</div>
	...
	<div class="var-header">
		<span class="var-title">
			...
			<span class="var-name">$__table</span>
			 = <span class="var-default"> 'event_targets_audience'</span>			(line <span class="line-number">33</span>)
		</span>
	</div>
