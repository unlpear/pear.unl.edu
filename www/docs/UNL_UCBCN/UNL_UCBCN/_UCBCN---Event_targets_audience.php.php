...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN | Docs for page Event_targets_audience.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/UCBCN/Event_targets_audience.php</h2>
...
<p class="short-description">Table Definition for event_targets_audience</p>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_UCBCN/UNL_UCBCN_Event_targets_audience.php">UNL_UCBCN_Event_targets_audience</a>
					</td>
					<td>
