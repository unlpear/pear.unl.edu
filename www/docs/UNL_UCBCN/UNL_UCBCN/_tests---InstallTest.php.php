...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN | Docs for page InstallTest.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/tests/InstallTest.php</h2>
...
<p class="short-description">This file is used to test the UNL_UCBCN installation.</p>
	<ul class="tags">
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_UCBCN/UNL_UCBCN_InstallTest.php">UNL_UCBCN_InstallTest</a>
					</td>
					<td>
											InstallTest class.
										</td>
	...
	<!-- ========== Info from phpDoc block ========= -->
<p class="short-description">Require the PHPUnit framework and UNL_UCBCN backend system.</p>
