...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN | Docs for page calGrouper.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/scripts/calGrouper.php</h2>
...
<p class="short-description">This script will group calendars all under one account.</p>
<div class="description"><p>Usage: php calGrouper.php &quot;UNL Events&quot; bbieber2 ppeters1</p><p>PHP version 5</p></div>
	<ul class="tags">
