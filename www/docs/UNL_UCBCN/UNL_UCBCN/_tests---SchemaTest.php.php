...
<div class="description"><p>This is based on an example file from MDB2_Schema.</p></div>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_UCBCN/UNL_UCBCN_SchemaTest.php">UNL_UCBCN_SchemaTest</a>
					</td>
					<td>
	...
	<!-- ========== Info from phpDoc block ========= -->
<p class="short-description">Require the PHPUnit framework.</p>
...
<div class="evenrow">
	...
	<div>
		<span class="include-title">
			<span class="include-type">require_once</span>
			(<span class="include-name">'MDB2/Driver/sqlite.php'</span>)
