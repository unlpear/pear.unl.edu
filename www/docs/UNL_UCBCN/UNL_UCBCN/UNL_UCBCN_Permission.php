...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN | Docs For Class UNL_UCBCN_Permission</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="class-name">Class UNL_UCBCN_Permission</h2>
...
<p class="short-description">ORM for a record within the database.</p>
	<ul class="tags">
		...
		<p class="notes">
			Located in <a class="field" href="_UNL---UCBCN---Permission.php.php">/UNL/UCBCN/Permission.php</a> (line <span class="field">28</span>)
		</p>
		
				
		<pre>DB_DataObject
   |
   --UNL_UCBCN_Permission</pre>
	...
	<div class="var-header">
		<span class="var-title">
			...
			<span class="var-name">$fb_linkDisplayFields</span>
			 = <span class="var-default">array('name')</span>			(line <span class="line-number">44</span>)
		</span>
	</div>
	...
	<div class="var-header">
		<span class="var-title">
			...
			<span class="var-name">$__table</span>
			 = <span class="var-default"> 'permission'</span>			(line <span class="line-number">33</span>)
		</span>
	</div>
...
<div class="oddrow">
	...
	<div class="method-header">
		<span class="method-title">keys</span> (line <span class="line-number">55</span>)
	</div> 
...
<div class="evenrow">
	...
	<div class="method-header">
		<span class="method-title">sequenceKey</span> (line <span class="line-number">62</span>)
	</div> 
