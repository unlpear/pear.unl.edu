...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN | Docs for page addAccount.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/scripts/addAccount.php</h2>
...
<p class="short-description">This file will add an account.</p>
