...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN | Docs for page User_has_permission.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/UCBCN/User_has_permission.php</h2>
...
<p class="short-description">Table Definition for user_has_permission</p>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_UCBCN/UNL_UCBCN_User_has_permission.php">UNL_UCBCN_User_has_permission</a>
					</td>
					<td>
