...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN | Docs For Class UNL_UCBCN_Eventtype</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="class-name">Class UNL_UCBCN_Eventtype</h2>
...
<p class="short-description">ORM for a record within the database.</p>
		<p class="notes">
			Located in <a class="field" href="_UCBCN---Eventtype.php.php">/UCBCN/Eventtype.php</a> (line <span class="field">15</span>)
		</p>
		
				
		<pre>DB_DataObject
   |
   --UNL_UCBCN_Eventtype</pre>
		...
		<div class="info-box-body">
			<div class="var-summary">
					...
					<a href="#$description" title="details" class="var-name">$description</a>
																...
																<div class="var-title">
					<span class="var-type">mixed</span>
					<a href="#$eventtypegroup" title="details" class="var-name">$eventtypegroup</a>
				</div>
																<div class="var-title">
					<span class="var-type">mixed</span>
					...
					<a href="#$name" title="details" class="var-name">$name</a>
																...
																<div class="var-title">
					<span class="var-type">mixed</span>
					<a href="#$standard" title="details" class="var-name">$standard</a>
				</div>
																<div class="var-title">
					<span class="var-type">mixed</span>
...
<a name="var$eventtypegroup" id="$eventtypegroup"><!-- --></A>
<div class="evenrow">

	<div class="var-header">
		<span class="var-title">
			<span class="var-type">mixed</span>
			<span class="var-name">$eventtypegroup</span>
	...
	<div class="var-header">
		<span class="var-title">
			...
			<span class="var-name">$fb_linkDisplayFields</span>
			 = <span class="var-default">array('name')</span>			(line <span class="line-number">34</span>)
		</span>
	</div>
...
<a name="var$standard" id="$standard"><!-- --></A>
<div class="evenrow">
	...
	<div class="var-header">
		<span class="var-title">
			...
			<span class="var-name">$__table</span>
			 = <span class="var-default"> 'eventtype'</span>			(line <span class="line-number">20</span>)
		</span>
	</div>
...
<div class="evenrow">
	...
	<p class="notes" id="credit">
		Documentation generated on Mon, 22 Jan 2007 17:11:00 -0600 by <a href="http://www.phpdoc.org" target="_blank">phpDocumentor 1.3.1</a>
	</p>
	</div>
<?php
