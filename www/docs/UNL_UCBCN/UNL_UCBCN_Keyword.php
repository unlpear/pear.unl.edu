...
<p class="short-description">ORM for a record within the database.</p>
		<p class="notes">
			Located in <a class="field" href="_UCBCN---Keyword.php.php">/UCBCN/Keyword.php</a> (line <span class="field">15</span>)
		</p>
	...
	<div class="var-header">
		<span class="var-title">
			...
			<span class="var-name">$__table</span>
			 = <span class="var-default"> 'keyword'</span>			(line <span class="line-number">20</span>)
		</span>
	</div>
