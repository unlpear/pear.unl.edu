...
<p class="short-description">ORM for a record within the database.</p>
		<p class="notes">
			Located in <a class="field" href="_UCBCN---Event_targets_audience.php.php">/UCBCN/Event_targets_audience.php</a> (line <span class="field">15</span>)
		</p>
	...
	<div class="var-header">
		<span class="var-title">
			...
			<span class="var-name">$__table</span>
			 = <span class="var-default"> 'event_targets_audience'</span>			(line <span class="line-number">20</span>)
		</span>
	</div>
...
<div class="oddrow">
	...
	<div class="method-header">
		<span class="method-title">staticGet</span> (line <span class="line-number">25</span>)
	</div> 
