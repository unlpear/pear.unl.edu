...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN | Docs For Class UNL_UCBCN_Session</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="class-name">Class UNL_UCBCN_Session</h2>
...
<p class="short-description">ORM for a record within the database.</p>
		<p class="notes">
			Located in <a class="field" href="_UCBCN---Session.php.php">/UCBCN/Session.php</a> (line <span class="field">15</span>)
		</p>
		
				
		<pre>DB_DataObject
   |
   --UNL_UCBCN_Session</pre>
		...
		<div class="info-box-body">
			<div class="var-summary">
					...
					<a href="#$data" title="details" class="var-name">$data</a>
																...
																<div class="var-title">
					<span class="var-type">mixed</span>
					<a href="#$lastaction" title="details" class="var-name">$lastaction</a>
				</div>
																<div class="var-title">
					<span class="var-type">mixed</span>
					<a href="#$user_uid" title="details" class="var-name">$user_uid</a>
				</div>
																<div class="var-title">
					<span class="var-type">mixed</span>
...
<a name="var$lastaction" id="$lastaction"><!-- --></A>
<div class="oddrow">
...
<a name="var$user_uid" id="$user_uid"><!-- --></A>
<div class="evenrow">
	...
	<div class="var-header">
		<span class="var-title">
			...
			<span class="var-name">$__table</span>
			 = <span class="var-default"> 'session'</span>			(line <span class="line-number">20</span>)
		</span>
	</div>
...
<div class="evenrow">
	...
	<p class="notes" id="credit">
		Documentation generated on Mon, 22 Jan 2007 17:11:10 -0600 by <a href="http://www.phpdoc.org" target="_blank">phpDocumentor 1.3.1</a>
	</p>
	</div>
<?php
