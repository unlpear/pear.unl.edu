...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_Services_Peoplefinder | Docs for page example.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/docs/examples/example.php</h2>
...
<p class="short-description">Simple example to get the full name of a user from a UID.</p>
<div class="description"><p>PHP version 5</p></div>
	...
	<div>
		<span class="include-title">
			...
			(<span class="include-name">'UNL/Services/Peoplefinder.php'</span>)
			(line <span class="line-number">18</span>)
		</span>
	</div>

	<!-- ========== Info from phpDoc block ========= -->
<p class="short-description">Include the Peoplefinder services file.</p>
