...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_Services_Peoplefinder | Docs for page Peoplefinder.php</title>";
$p->breadcrumbs = '<ul>
...
<p class="short-description">Package which connects to the peoplefinder services to get information about UNL people.</p>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_Services_Peoplefinder/UNL_Services_Peoplefinder.php">UNL_Services_Peoplefinder</a>
					</td>
					<td>
