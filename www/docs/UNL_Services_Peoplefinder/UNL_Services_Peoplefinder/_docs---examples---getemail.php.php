...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_Services_Peoplefinder | Docs for page getemail.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/docs/examples/getemail.php</h2>
...
<p class="short-description">Simple example to get the email address from a UNL uid.</p>
