...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_Geography_SpatialData_Campus | Docs for page Campus.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/Campus.php</h2>
...
<p class="short-description">This package houses and returns spatial data for the UNL Campus.</p>
<div class="description"><p>Initially we only have latitude and longitude for a few buildings on campus.</p></div>
	<ul class="tags">
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_Geography_SpatialData_Campus/UNL_Geography_SpatialData_Campus.php">UNL_Geography_SpatialData_Campus</a>
					</td>
					<td>
