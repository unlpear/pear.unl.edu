...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_Geography_SpatialData_Campus | Docs For Class UNL_Geography_SpatialData_Campus</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="class-name">Class UNL_Geography_SpatialData_Campus</h2>
...
<div class="info-box">
	...
	<div class="info-box-body">
		...
		<p class="notes">
			Located in <a class="field" href="_Campus.php.php">/Campus.php</a> (line <span class="field">13</span>)
		</p>
			...
			<div class="method-summary">
					...
					static 						<span class="method-result">void</span>
										...
										()
												...
												<div class="method-definition">
											<span class="method-result">UNL_Geography_SpatialData_Campus</span>
										...
										<a href="#getGeoCoordinates" title="details" class="method-name">getGeoCoordinates</a>
											(<span class="var-type">string</span>&nbsp;<span class="var-name">$code</span>)
									</div>
																<div class="method-definition">
											<span class="method-result">string</span>
										<a href="#getMapURL" title="details" class="method-name">getMapURL</a>
											(<span class="var-type">string</span>&nbsp;<span class="var-name">$code</span>)
									</div>
																																								<div class="method-definition">
	...
	<div class="var-header">
		<span class="var-title">
			...
			<span class="var-name">$db_file</span>
			 = <span class="var-default"> 'spatialdata.sqlite'</span>			(line <span class="line-number">15</span>)
		</span>
	</div>
...
<div class="evenrow">
	...
	<div class="method-header">
		<span class="method-title">static method getDataDir</span> (line <span class="line-number">120</span>)
	</div> 
...
<div class="oddrow">
	...
	<div class="method-header">
		<span class="method-title">static method getDB</span> (line <span class="line-number">26</span>)
	</div> 
...
<div class="evenrow">
	...
	<div class="method-header">
		<span class="method-title">static method getTableDefinition</span> (line <span class="line-number">128</span>)
	</div> 
...
<div class="oddrow">
	...
	<div class="method-header">
		<span class="method-title">static method importCSV</span> (line <span class="line-number">49</span>)
	</div> 
...
<div class="evenrow">
	...
	<div class="method-header">
		<span class="method-title">static method tableExists</span> (line <span class="line-number">34</span>)
	</div> 
...
<div class="oddrow">
	...
	<div class="method-header">
		<span class="method-title">static method __connect</span> (line <span class="line-number">41</span>)
	</div> 
...
<div class="oddrow">
	...
	<div class="method-header">
		<span class="method-title">buildingExists</span> (line <span class="line-number">99</span>)
	</div> 
...
<a name="methodgetGeoCoordinates" id="getGeoCoordinates"><!-- --></a>
<div class="evenrow">
	
	<div class="method-header">
		<span class="method-title">getGeoCoordinates</span> (line <span class="line-number">71</span>)
	</div> 
	
	<!-- ========== Info from phpDoc block ========= -->
<p class="short-description">Returns the geographical coordinates for a building.</p>
	<ul class="tags">
				<li><span class="field">return:</span> array of coordinates lat and lon. false on error.</li>
			</ul>
...
<a name="methodgetMapURL" id="getMapURL"><!-- --></a>
<div class="oddrow">
	
	<div class="method-header">
		<span class="method-title">getMapURL</span> (line <span class="line-number">114</span>)
	</div> 
	
	<!-- ========== Info from phpDoc block ========= -->
<p class="short-description">returns the map url for a given building.</p>
	<ul class="tags">
				<li><span class="field">return:</span> URL to the map.</li>
			</ul>
...
<div class="evenrow">
	...
	<div class="method-header">
		<span class="method-title">_checkDB</span> (line <span class="line-number">86</span>)
	</div> 
