...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_Peoplefinder | Docs For Class UNL_Peoplefinder_Renderer_JSON</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="class-name">Class UNL_Peoplefinder_Renderer_JSON</h2>
...
<p class="short-description">Peoplefinder JSON renderer</p>
<div class="description"><p>PHP version 5</p></div>
	<ul class="tags">
		...
		<p class="notes">
			Located in <a class="field" href="_UNL---Peoplefinder---Renderer---JSON.php.php">/UNL/Peoplefinder/Renderer/JSON.php</a> (line <span class="field">14</span>)
		</p>
	...
	<div class="info-box">
		...
		<div class="info-box-body">			
			<div class="method-summary">
											...
											<span class="method-result">UNL_Peoplefinder_Renderer_JSON</span>
