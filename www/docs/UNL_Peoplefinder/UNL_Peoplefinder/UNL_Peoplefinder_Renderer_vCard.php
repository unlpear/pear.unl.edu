...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_Peoplefinder | Docs For Class UNL_Peoplefinder_Renderer_vCard</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="class-name">Class UNL_Peoplefinder_Renderer_vCard</h2>
...
<p class="short-description">Peoplefinder vcard renderer</p>
<div class="description"><p>PHP version 5</p></div>
	<ul class="tags">
		...
		<p class="notes">
			Located in <a class="field" href="_UNL---Peoplefinder---Renderer---vCard.php.php">/UNL/Peoplefinder/Renderer/vCard.php</a> (line <span class="field">14</span>)
		</p>
	...
	<div class="info-box">
		...
		<div class="info-box-body">
			<div class="var-summary">
					...
					<a href="#var_displayStudentTelephone" title="details" class="var-name">$displayStudentTelephone</a>
				</div>
											</div>
		</div>
	</div>
	...
	<div class="info-box">
		...
		<div class="info-box-body">
			<a name="var_displayStudentTelephone" id="var_displayStudentTelephone"><!-- --></a>
<div class="evenrow">

	<div class="var-header">
		<span class="var-title">
			<span class="var-type">mixed</span>
			<span class="var-name">$displayStudentTelephone</span>
			 = <span class="var-default"> false</span>			(line <span class="line-number">17</span>)
		</span>
	</div>
...
<div class="oddrow">
	...
	<div class="method-header">
		<span class="method-title">renderRecord</span> (line <span class="line-number">19</span>)
	</div> 
