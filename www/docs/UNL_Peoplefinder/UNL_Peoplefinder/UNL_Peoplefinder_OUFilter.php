...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_Peoplefinder | Docs For Class UNL_Peoplefinder_OUFilter</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="class-name">Class UNL_Peoplefinder_OUFilter</h2>
...
<p class="short-description">Builds a simple ou filter for records.</p>
<div class="description"><p>PHP version 5</p></div>
	<ul class="tags">
		...
		<p class="notes">
			Located in <a class="field" href="_UNL---Peoplefinder---OUFilter.php.php">/UNL/Peoplefinder/OUFilter.php</a> (line <span class="field">14</span>)
		</p>
	...
	<div class="info-box">
		...
		<div class="info-box-body">			
			<div class="method-summary">
											...
											<span class="method-result">UNL_Peoplefinder_OUFilter</span>
										<a href="#__construct" title="details" class="method-name">__construct</a>
											(<span class="var-type">string</span>&nbsp;<span class="var-name">$ou</span>)
									</div>
																<div class="method-definition">
...
<div class="evenrow">
	...
	<!-- ========== Info from phpDoc block ========= -->
<p class="short-description">Create a filter for OU filtering.</p>
	...
	<div class="method-signature">
		...
		<span class="method-name">
			...
			<ul class="parameters">
				...
				<span class="var-name">$ou</span><span class="var-description">: Organizational Unit eg:org|College of Engineering</span>			</li>
				</ul>
