...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_Peoplefinder | Docs For Class Peoplefinder_Renderer_vCard</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="class-name">Class Peoplefinder_Renderer_vCard</h2>
...
<div class="description"><p>PHP version 5</p></div>
	<ul class="tags">
		...
		<p class="notes">
			Located in <a class="field" href="_Peoplefinder---Renderer---vCard.php.php">/Peoplefinder/Renderer/vCard.php</a> (line <span class="field">14</span>)
		</p>
