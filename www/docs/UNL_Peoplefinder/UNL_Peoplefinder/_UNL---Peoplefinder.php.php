...
?>
			<div class="page-body">			
<h2 class="file-name">/UNL/Peoplefinder.php</h2>
...
<div class="description"><p>PHP version 5</p></div>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_Peoplefinder/UNL_Peoplefinder.php">UNL_Peoplefinder</a>
					</td>
					<td>
	...
	<div>
		<span class="include-title">
			...
			(<span class="include-name">dirname(__FILE__).'/Peoplefinder/Record.php'</span>)
	...
	<div class="info-box">
		...
		<div class="info-box-body">	
			<a name="defineUNL_PF_DISPLAY_LIMIT"><!-- --></a>
<div class="evenrow">
	
	<div>
		<span class="const-title">
			<span class="const-name">UNL_PF_DISPLAY_LIMIT</span> = 30
...
<a name="defineUNL_PF_RESULT_LIMIT"><!-- --></a>
<div class="oddrow">
	
	<div>
		<span class="const-title">
			<span class="const-name">UNL_PF_RESULT_LIMIT</span> = 100
