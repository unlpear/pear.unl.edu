...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_Peoplefinder | Docs For Class UNL_Peoplefinder_TelephoneFilter</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="class-name">Class UNL_Peoplefinder_TelephoneFilter</h2>
...
<p class="short-description">Builds a simple telephone filter for searching for records.</p>
<div class="description"><p>PHP version 5</p></div>
	<ul class="tags">
		...
		<p class="notes">
			Located in <a class="field" href="_UNL---Peoplefinder---TelephoneFilter.php.php">/UNL/Peoplefinder/TelephoneFilter.php</a> (line <span class="field">14</span>)
		</p>
	...
	<div class="info-box">
		...
		<div class="info-box-body">			
			<div class="method-summary">
											...
											<span class="method-result">UNL_Peoplefinder_TelephoneFilter</span>
...
<div class="oddrow">
	...
	<div class="method-header">
		<span class="method-title">__toString</span> (line <span class="line-number">25</span>)
	</div> 
