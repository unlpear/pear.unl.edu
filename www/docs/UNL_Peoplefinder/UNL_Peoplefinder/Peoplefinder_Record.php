...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_Peoplefinder | Docs For Class Peoplefinder_Record</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="class-name">Class Peoplefinder_Record</h2>
...
<div class="description"><p>PHP version 5</p></div>
	<ul class="tags">
		...
		<p class="notes">
			Located in <a class="field" href="_Peoplefinder---Record.php.php">/Peoplefinder/Record.php</a> (line <span class="field">13</span>)
		</p>
...
<div class="oddrow">
	...
	<div class="method-header">
		<span class="method-title">static method fromLDAPEntry</span> (line <span class="line-number">44</span>)
	</div> 
...
<div class="evenrow">
	...
	<div class="method-header">
		<span class="method-title">formatPostalAddress</span> (line <span class="line-number">63</span>)
	</div> 
