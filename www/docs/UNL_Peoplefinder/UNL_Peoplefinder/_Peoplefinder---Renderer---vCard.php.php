...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_Peoplefinder | Docs for page vCard.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/Peoplefinder/Renderer/vCard.php</h2>
...
<div class="info-box">
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_Peoplefinder/Peoplefinder_Renderer_vCard.php">Peoplefinder_Renderer_vCard</a>
					</td>
					<td>
	...
	<p class="notes" id="credit">
		Documentation generated on Wed, 09 Jan 2008 11:51:57 -0600 by <a href="http://www.phpdoc.org" target="_blank">phpDocumentor 1.4.1</a>
	</p>
	</div>
<?php
