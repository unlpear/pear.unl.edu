...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_Peoplefinder | Docs for page TelephoneFilter.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/UNL/Peoplefinder/TelephoneFilter.php</h2>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_Peoplefinder/UNL_Peoplefinder_TelephoneFilter.php">UNL_Peoplefinder_TelephoneFilter</a>
					</td>
					<td>
