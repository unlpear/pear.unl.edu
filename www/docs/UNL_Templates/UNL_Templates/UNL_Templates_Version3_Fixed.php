...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_Templates | Docs For Class UNL_Templates_Version3_Fixed</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="class-name">Class UNL_Templates_Version3_Fixed</h2>
...
<p class="short-description">Template Definition for fixed.dwt</p>
	<ul class="tags">
		...
		<p class="notes">
			Located in <a class="field" href="_UNL---Templates---Version3---Fixed.php.php">/UNL/Templates/Version3/Fixed.php</a> (line <span class="field">27</span>)
		</p>
   ...
   --<a href="../UNL_Templates/UNL_Templates.php">UNL_Templates</a>
      |
      --UNL_Templates_Version3_Fixed</pre>
	...
	<div class="var-header">
		<span class="var-title">
			...
			<span class="var-name">$__template</span>
			 = <span class="var-default"> 'Fixed.tpl'</span>			(line <span class="line-number">32</span>)
		</span>
	</div>
