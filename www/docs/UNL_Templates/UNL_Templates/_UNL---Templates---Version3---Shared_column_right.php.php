...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_Templates | Docs for page Shared_column_right.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/UNL/Templates/Version3/Shared_column_right.php</h2>
...
<div class="description"><p>PHP version 5</p></div>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_Templates/UNL_Templates_Version3_Shared_column_right.php">UNL_Templates_Version3_Shared_column_right</a>
					</td>
					<td>
	...
	<div>
		<span class="include-title">
			...
			(<span class="include-name"><a href="../UNL_Templates/_UNL---Templates.php.php">'UNL/Templates.php'</a></span>)
