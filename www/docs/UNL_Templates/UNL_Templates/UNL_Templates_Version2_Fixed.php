...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_Templates | Docs For Class UNL_Templates_Version2_Fixed</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="class-name">Class UNL_Templates_Version2_Fixed</h2>
...
<p class="short-description">Fixed width template object.</p>
	<ul class="tags">
		...
		<p class="notes">
			Located in <a class="field" href="_UNL---Templates---Version2---Fixed.php.php">/UNL/Templates/Version2/Fixed.php</a> (line <span class="field">24</span>)
		</p>
   ...
   --<a href="../UNL_Templates/UNL_Templates.php">UNL_Templates</a>
      |
      --UNL_Templates_Version2_Fixed</pre>
	...
	<div class="var-header">
		<span class="var-title">
			...
			<span class="var-name">$__template</span>
			 = <span class="var-default"> 'Fixed.tpl'</span>			(line <span class="line-number">29</span>)
		</span>
	</div>
