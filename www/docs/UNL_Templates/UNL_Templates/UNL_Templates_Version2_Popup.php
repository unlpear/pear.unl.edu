...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_Templates | Docs For Class UNL_Templates_Version2_Popup</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="class-name">Class UNL_Templates_Version2_Popup</h2>
...
<p class="short-description">popup template object</p>
	<ul class="tags">
		...
		<p class="notes">
			Located in <a class="field" href="_UNL---Templates---Version2---Popup.php.php">/UNL/Templates/Version2/Popup.php</a> (line <span class="field">23</span>)
		</p>
   ...
   --<a href="../UNL_Templates/UNL_Templates.php">UNL_Templates</a>
      |
      --UNL_Templates_Version2_Popup</pre>
	...
	<div class="var-header">
		<span class="var-title">
			...
			<span class="var-name">$__template</span>
			 = <span class="var-default"> 'Popup.tpl'</span>			(line <span class="line-number">28</span>)
		</span>
	</div>
