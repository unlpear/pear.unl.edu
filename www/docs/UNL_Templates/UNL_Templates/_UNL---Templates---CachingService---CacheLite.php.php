...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_Templates | Docs for page CacheLite.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/UNL/Templates/CachingService/CacheLite.php</h2>
...
<p class="short-description">A Cache Service using Cache_Lite</p>
<div class="description"><p>PHP version 5</p></div>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_Templates/UNL_Templates_CachingService_CacheLite.php">UNL_Templates_CachingService_CacheLite</a>
					</td>
					<td>
	...
	<div>
		<span class="include-title">
			...
			(<span class="include-name"><a href="../UNL_Templates/_UNL---Templates---CachingService.php.php">'UNL/Templates/CachingService.php'</a></span>)
