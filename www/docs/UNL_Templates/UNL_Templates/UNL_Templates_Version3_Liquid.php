...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_Templates | Docs For Class UNL_Templates_Version3_Liquid</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="class-name">Class UNL_Templates_Version3_Liquid</h2>
...
<p class="short-description">Template Definition for liquid.dwt</p>
	<ul class="tags">
		...
		<p class="notes">
			Located in <a class="field" href="_UNL---Templates---Version3---Liquid.php.php">/UNL/Templates/Version3/Liquid.php</a> (line <span class="field">27</span>)
		</p>
   ...
   --<a href="../UNL_Templates/UNL_Templates.php">UNL_Templates</a>
      |
      --UNL_Templates_Version3_Liquid</pre>
	...
	<div class="var-header">
		<span class="var-title">
			...
			<span class="var-name">$__template</span>
			 = <span class="var-default"> 'Liquid.tpl'</span>			(line <span class="line-number">32</span>)
		</span>
	</div>
