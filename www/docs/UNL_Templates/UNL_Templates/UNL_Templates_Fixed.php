...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_Templates | Docs For Class UNL_Templates_Fixed</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="class-name">Class UNL_Templates_Fixed</h2>
...
<p class="short-description">Fixed width template object.</p>
	<ul class="tags">
		...
		<p class="notes">
			Located in <a class="field" href="_Templates---Fixed.php.php">/Templates/Fixed.php</a> (line <span class="field">16</span>)
		</p>
	...
	<div class="var-header">
		<span class="var-title">
			...
			<span class="var-name">$__template</span>
			 = <span class="var-default"> 'Fixed.tpl'</span>			(line <span class="line-number">21</span>)
		</span>
	</div>
