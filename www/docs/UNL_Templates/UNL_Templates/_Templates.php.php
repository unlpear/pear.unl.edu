...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_Templates | Docs for page Templates.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/Templates.php</h2>
...
<p class="short-description">Object oriented interface to create UNL Template based HTML pages.</p>
<div class="description"><p>PHP version 5</p></div>
	...
	<div>
		<span class="include-title">
			...
			(<span class="include-name">'UNL/DWT.php'</span>)
			(line <span class="line-number">19</span>)
		</span>
	</div>

	<!-- ========== Info from phpDoc block ========= -->
<p class="short-description">Utilizes the UNL_DWT Dreamweaver template class.</p>
...
<div class="oddrow">
	...
	<!-- ========== Info from phpDoc block ========= -->
<p class="short-description">Cache lite is used to cache the raw template files, and can also be used to  cached the rendered HTML output.</p>
