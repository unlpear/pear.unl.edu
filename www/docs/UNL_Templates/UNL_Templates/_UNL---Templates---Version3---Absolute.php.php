...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_Templates | Docs for page Absolute.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/UNL/Templates/Version3/Absolute.php</h2>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_Templates/UNL_Templates_Version3_Absolute.php">UNL_Templates_Version3_Absolute</a>
					</td>
					<td>
