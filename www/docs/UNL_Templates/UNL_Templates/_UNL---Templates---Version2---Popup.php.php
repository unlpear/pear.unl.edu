...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_Templates | Docs for page Popup.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/UNL/Templates/Version2/Popup.php</h2>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_Templates/UNL_Templates_Version2_Popup.php">UNL_Templates_Version2_Popup</a>
					</td>
					<td>
