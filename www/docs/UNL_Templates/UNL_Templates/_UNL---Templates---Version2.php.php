...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_Templates | Docs for page Version2.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/UNL/Templates/Version2.php</h2>
...
<p class="short-description">Base class for version 2 (2006) of the template files.</p>
<div class="description"><p>PHP version 5</p></div>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_Templates/UNL_Templates_Version2.php">UNL_Templates_Version2</a>
					</td>
					<td>
	...
	<div>
		<span class="include-title">
			...
			(<span class="include-name"><a href="../UNL_Templates/_UNL---Templates---Version.php.php">'UNL/Templates/Version.php'</a></span>)
