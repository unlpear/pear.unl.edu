...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_Templates | Docs for page Scanner.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/UNL/Templates/Scanner.php</h2>
...
<p class="short-description">This class will scan a template file for the regions, which you can use to  analyze and use a rendered template file.</p>
<div class="description"><p>PHP version 5</p></div>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_Templates/UNL_Templates_Scanner.php">UNL_Templates_Scanner</a>
					</td>
					<td>
	...
	<div>
		<span class="include-title">
			...
			(<span class="include-name">'UNL/DWT/Scanner.php'</span>)
