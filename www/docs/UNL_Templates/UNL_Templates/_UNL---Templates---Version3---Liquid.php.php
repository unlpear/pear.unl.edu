...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_Templates | Docs for page Liquid.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/UNL/Templates/Version3/Liquid.php</h2>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_Templates/UNL_Templates_Version3_Liquid.php">UNL_Templates_Version3_Liquid</a>
					</td>
					<td>
