...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_Templates | Docs for page CachingService.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/UNL/Templates/CachingService.php</h2>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_Templates/UNL_Templates_CachingService.php">UNL_Templates_CachingService</a>
					</td>
					<td>
