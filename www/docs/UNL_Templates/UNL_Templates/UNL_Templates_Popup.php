...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_Templates | Docs For Class UNL_Templates_Popup</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="class-name">Class UNL_Templates_Popup</h2>
...
<p class="short-description">popup template object</p>
	<ul class="tags">
		...
		<p class="notes">
			Located in <a class="field" href="_Templates---Popup.php.php">/Templates/Popup.php</a> (line <span class="field">15</span>)
		</p>
	...
	<div class="var-header">
		<span class="var-title">
			...
			<span class="var-name">$__template</span>
			 = <span class="var-default"> 'Popup.tpl'</span>			(line <span class="line-number">20</span>)
		</span>
	</div>
