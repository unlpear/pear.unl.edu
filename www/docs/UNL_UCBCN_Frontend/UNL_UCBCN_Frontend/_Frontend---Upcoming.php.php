...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN_Frontend | Docs for page Upcoming.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/Frontend/Upcoming.php</h2>
...
<p class="short-description">This class contains the information needed for viewing the list of upcoming  events within the calendar system.</p>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_UCBCN_Frontend/UNL_UCBCN_Frontend_Upcoming.php">UNL_UCBCN_Frontend_Upcoming</a>
					</td>
					<td>
...
<div class="evenrow">
	...
	<p class="notes" id="credit">
		Documentation generated on Thu, 19 Feb 2009 13:35:58 -0600 by <a href="http://www.phpdoc.org" target="_blank">phpDocumentor 1.4.2</a>
	</p>
	</div>
<?php
