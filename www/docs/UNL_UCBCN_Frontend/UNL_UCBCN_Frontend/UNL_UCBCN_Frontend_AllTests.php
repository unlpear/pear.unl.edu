...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN_Frontend | Docs For Class UNL_UCBCN_Frontend_AllTests</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="class-name">Class UNL_UCBCN_Frontend_AllTests</h2>
...
<div class="oddrow">
	...
	<!-- ========== Info from phpDoc block ========= -->
<p class="short-description">Adds the UNL_UCBCN_FrontendTest suite.</p>
	<ul class="tags">
				<li><span class="field">access:</span> public</li>
			</ul>
