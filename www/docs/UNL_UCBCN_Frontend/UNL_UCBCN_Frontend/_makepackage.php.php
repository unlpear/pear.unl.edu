...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN_Frontend | Docs for page makepackage.php</title>";
$p->breadcrumbs = '<ul>
...
<p class="short-description">This file creates a package.xml which describes the pear package to be built.</p>
<div class="description"><p>It provides the package.xml from which you can run pear package and create a  distributable Package.tgz installable through the PEAR installer.</p><p><div class="src-code"><ol><li><div class="src-line">&nbsp;<span class="src-id">php&nbsp;makepackage</span>.<span class="src-id">php&nbsp;make&nbsp;</span>&amp;&amp;&nbsp;<span class="src-id">pear&nbsp;package&nbsp;</span>&amp;&amp;&nbsp;<span class="src-id">pear&nbsp;install&nbsp;_______</span>.<span class="src-id">tgz</span></div></li>
