...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN_Frontend | Docs for page UNL_UCBCN_Frontend_setup.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/UNL_UCBCN_Frontend_setup.php</h2>
...
<p class="short-description">Contains the post-install script task for installing the frontend.</p>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_UCBCN_Frontend/UNL_UCBCN_Frontend_setup_postinstall.php">UNL_UCBCN_Frontend_setup_postinstall</a>
					</td>
					<td>
