...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN_Frontend | Docs for page MonthWidget.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/Frontend/MonthWidget.php</h2>
...
<p class="short-description">This class defines a 30 day widget containing information for a given month.</p>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_UCBCN_Frontend/UNL_UCBCN_Frontend_MonthWidget.php">UNL_UCBCN_Frontend_MonthWidget</a>
					</td>
					<td>
...
<div class="oddrow">
	...
	<div>
		<span class="include-title">
			<span class="include-type">require_once</span>
			(<span class="include-name">'Calendar/Month/Weekdays.php'</span>)
...
<div class="evenrow">
	...
	<div>
		<span class="include-title">
			<span class="include-type">require_once</span>
			(<span class="include-name">'Calendar/Util/Textual.php'</span>)
