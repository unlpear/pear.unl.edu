...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN_Frontend | Docs for page EventListing_icalendar.tpl.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/templates/vanilla/EventListing_icalendar.tpl.php</h2>
...
<p class="short-description">This is the output for an event listing in icalendar format.</p>
