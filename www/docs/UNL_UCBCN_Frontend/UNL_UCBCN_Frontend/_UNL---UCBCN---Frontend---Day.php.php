...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN_Frontend | Docs for page Day.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/UNL/UCBCN/Frontend/Day.php</h2>
...
<p class="short-description">This class contains the information needed for viewing a single day view calendar.</p>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_UCBCN_Frontend/UNL_UCBCN_Frontend_Day.php">UNL_UCBCN_Frontend_Day</a>
					</td>
					<td>
...
<div class="evenrow">
	...
	<div>
		<span class="include-title">
			<span class="include-type">require_once</span>
			(<span class="include-name"><a href="../UNL_UCBCN_Frontend/_UNL---UCBCN---Frontend---MonthWidget.php.php">'UNL/UCBCN/Frontend/MonthWidget.php'</a></span>)
			(line <span class="line-number">21</span>)
		</span>
	</div>

	<!-- ========== Info from phpDoc block ========= -->
<p class="short-description">Month widget is used for navigation within the month this day resides</p>
...
<div class="oddrow">
	...
	<!-- ========== Info from phpDoc block ========= -->
<p class="short-description">Event listings hold an array of events for this day.</p>
...
<div class="evenrow">
	...
	<div>
		<span class="include-title">
			<span class="include-type">require_once</span>
			(<span class="include-name">'Calendar/Day.php'</span>)
			(line <span class="line-number">31</span>)
		</span>
	</div>

	<!-- ========== Info from phpDoc block ========= -->
<p class="short-description">Calendar_Day is used for day manipulation and date verification.</p>
