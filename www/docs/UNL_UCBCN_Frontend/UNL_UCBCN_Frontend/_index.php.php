...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN_Frontend | Docs for page index.php</title>";
$p->breadcrumbs = '<ul>
...
<p class="short-description">Sample index file for running the frontend. This is a simple file which creates  a new UNL_UCBCN_Frontend object and handles sending the output to the user.</p>
<div class="description"><p>PHP version 5</p></div>
	...
	<div>
		<span class="include-title">
			...
			(<span class="include-name">'UNL/UCBCN/Autoload.php'</span>)
