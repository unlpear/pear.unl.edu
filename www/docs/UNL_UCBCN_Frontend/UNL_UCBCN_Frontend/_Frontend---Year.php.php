...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN_Frontend | Docs for page Year.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/Frontend/Year.php</h2>
...
<p class="short-description">This class is for the frontend view for an entire year.</p>
<div class="description"><p>It contains basically 4 rows of 3 months, for a total of 12  monthwidgets.</p><p>PHP version 5</p></div>
	<ul class="tags">
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_UCBCN_Frontend/UNL_UCBCN_Frontend_Year.php">UNL_UCBCN_Frontend_Year</a>
					</td>
					<td>
