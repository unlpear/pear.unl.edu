...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN_Frontend | Docs For Class UNL_UCBCN_Frontend_NoEvents</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="class-name">Class UNL_UCBCN_Frontend_NoEvents</h2>
...
<p class="short-description">Object for the view of a single day for a calendar.</p>
	<ul class="tags">
		...
		<p class="notes">
			Located in <a class="field" href="_UNL---UCBCN---Frontend---NoEvents.php.php">/UNL/UCBCN/Frontend/NoEvents.php</a> (line <span class="field">26</span>)
		</p>
	...
	<div class="info-box">
		...
		<div class="info-box-body">
			<div class="var-summary">
					...
					<a href="#var_message" title="details" class="var-name">$message</a>
				</div>
											</div>
		</div>
	</div>
	...
	<div class="info-box">
		...
		<div class="info-box-body">			
			<div class="method-summary">
											...
											<span class="method-result">UNL_UCBCN_Frontend_NoEvents</span>
										<a href="#__construct" title="details" class="method-name">__construct</a>
											([<span class="var-type">string</span>&nbsp;<span class="var-name">$message</span> = <span class="var-default">null</span>])
									</div>
								</div>
		</div>
	</div>		
	...
	<div class="info-box">
		...
		<div class="info-box-body">
			<a name="var_message" id="var_message"><!-- --></a>
<div class="oddrow">
	...
	<div class="var-header">
		<span class="var-title">
			...
			<span class="var-name">$message</span>
			 = <span class="var-default"> 'Sorry, no events were found.'</span>			(line <span class="line-number">33</span>)
		</span>
	</div>
...
<div class="evenrow">
	...
	<!-- ========== Info from phpDoc block ========= -->
<p class="short-description">Constructs an object when no events are present</p>
	<ul class="tags">
				<li><span class="field">access:</span> public</li>
			</ul>
	...
	<div class="method-signature">
		...
		<span class="method-name">
			...
			<ul class="parameters">
					<li>
				<span class="var-type">string</span>
				<span class="var-name">$message</span><span class="var-description">: Message to display when no events are present.</span>			</li>
				</ul>
