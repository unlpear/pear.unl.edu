...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_Common | Docs for page City.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/Common/Building/City.php</h2>
...
<div class="info-box">
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_Common/UNL_Common_Building_City.php">UNL_Common_Building_City</a>
					</td>
					<td>
	...
	<div>
		<span class="include-title">
			...
			(<span class="include-name">dirname(__FILE__).'/../../Common.php'</span>)
