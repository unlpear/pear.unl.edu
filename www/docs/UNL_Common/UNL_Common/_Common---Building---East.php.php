...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_Common | Docs for page East.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/Common/Building/East.php</h2>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_Common/UNL_Common_Building_East.php">UNL_Common_Building_East</a>
					</td>
					<td>
