...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_Common | Docs for page Colleges.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/Common/Colleges.php</h2>
...
<p class="short-description">College data for the UNL_Common package.</p>
	<ul class="tags">
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_Common/UNL_Common_Colleges.php">UNL_Common_Colleges</a>
					</td>
					<td>
