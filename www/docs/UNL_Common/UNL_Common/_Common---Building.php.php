...
?>
			<div class="page-body">			
<h2 class="file-name">/Common/Building.php</h2>
...
<p class="short-description">Structure for the UNL Common Building portions of the UNL_Common package.</p>
	<ul class="tags">
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_Common/UNL_Common_Building.php">UNL_Common_Building</a>
					</td>
					<td>
	...
	<div>
		<span class="include-title">
			...
			(<span class="include-name">'UNL/Common/Building/City.php'</span>)
...
<div class="evenrow">
	...
	<div>
		<span class="include-title">
			<span class="include-type">require_once</span>
			(<span class="include-name">'UNL/Common/Building/East.php'</span>)
