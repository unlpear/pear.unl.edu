...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_Common | Docs For Class UNL_Common_Building_East</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="class-name">Class UNL_Common_Building_East</h2>
...
<p class="short-description">Class which can retrieve the buildings and codes for East Campus</p>
		<p class="notes">
			Located in <a class="field" href="_Common---Building---East.php.php">/Common/Building/East.php</a> (line <span class="field">15</span>)
		</p>
...
<div class="evenrow">
	...
	<div class="method-header">
		<span class="method-title">static method getTableDefinition</span> (line <span class="line-number">41</span>)
	</div> 
...
<div class="evenrow">
	...
	<div class="method-header">
		<span class="method-title">_checkDB</span> (line <span class="line-number">33</span>)
	</div> 
