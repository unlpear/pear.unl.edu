...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_Common_Building_Info | Docs for page Info.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/Info.php</h2>
...
<p class="short-description">This package has information for buildings on campus.</p>
<div class="description"><p>Currently the information is structured in HTML snippets.</p></div>
	<ul class="tags">
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_Common_Building_Info/UNL_Common_Building_Info.php">UNL_Common_Building_Info</a>
					</td>
					<td>
