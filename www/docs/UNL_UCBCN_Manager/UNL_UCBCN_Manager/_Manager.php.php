...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN_Manager | Docs for page Manager.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/Manager.php</h2>
...
<p class="short-description">This class extends the UNL UCBerkeley Calendar backend system to create  a management frontend. It handles authentication for the user and allows  insertion of event details into the calendar backend.</p>
<div class="description"><p>It allows authenticated users to submit new events into the system.</p><p>PHP version 5</p></div>
	<ul class="tags">
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_UCBCN_Manager/UNL_UCBCN_Manager.php">UNL_UCBCN_Manager</a>
					</td>
					<td>
	...
	<div>
		<span class="include-title">
			...
			(<span class="include-name">'UNL/UCBCN/Manager/FormBuilder.php'</span>)
...
<div class="oddrow">
	...
	<div>
		<span class="include-title">
			<span class="include-type">require_once</span>
			(<span class="include-name">'Auth.php'</span>)
...
<div class="oddrow">
	...
	<div>
		<span class="include-title">
			<span class="include-type">require_once</span>
			(<span class="include-name">'UNL/UCBCN/EventListing.php'</span>)
...
<div class="evenrow">
	...
	<div>
		<span class="include-title">
			<span class="include-type">require_once</span>
			(<span class="include-name">'UNL/UCBCN/Manager/Tableless.php'</span>)
...
<div class="oddrow">
	...
	<div>
		<span class="include-title">
			<span class="include-type">require_once</span>
			(<span class="include-name">'UNL/UCBCN/Manager/FormBuilder_Driver.php'</span>)
...
<div class="evenrow">
	...
	<div>
		<span class="include-title">
			<span class="include-type">require_once</span>
			(<span class="include-name">'HTML/QuickForm/group.php'</span>)
...
<div class="oddrow">
	...
	<div>
		<span class="include-title">
			<span class="include-type">require_once</span>
			(<span class="include-name">'Pager/Pager.php'</span>)
			(line <span class="line-number">33</span>)
		</span>
	</div>

	<!-- ========== Info from phpDoc block ========= -->
<p class="short-description">For pagination of results.</p>
...
<div class="evenrow">
	...
	<div>
		<span class="include-title">
			<span class="include-type">require_once</span>
			(<span class="include-name">'UNL/UCBCN/Manager/Login.php'</span>)
	...
	<p class="notes" id="credit">
		Documentation generated on Thu, 19 Feb 2009 13:35:51 -0600 by <a href="http://www.phpdoc.org" target="_blank">phpDocumentor 1.4.2</a>
	</p>
	</div>
<?php
