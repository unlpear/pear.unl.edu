...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN_Manager | Docs For Class UNL_UCBCN_Manager_setup_postinstall</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="class-name">Class UNL_UCBCN_Manager_setup_postinstall</h2>
...
<p class="short-description">This class can handle all the post installation tasks for the manager.</p>
	<ul class="tags">
		...
		<p class="notes">
			Located in <a class="field" href="_UNL---UCBCN---Manager_setup.php.php">/UNL/UCBCN/Manager_setup.php</a> (line <span class="field">26</span>)
		</p>
	...
	<div class="info-box">
		...
		<div class="info-box-body">
			<div class="var-summary">
					...
					<a href="#var_createAccount" title="details" class="var-name">$createAccount</a>
				</div>
																<div class="var-title">
					<span class="var-type">bool</span>
	...
	<div class="info-box">
		...
		<div class="info-box-body">			
			<div class="method-summary">
											...
											<span class="method-result">bool|int</span>
	...
	<div class="info-box">
		...
		<div class="info-box-body">
			<a name="var_createAccount" id="var_createAccount"><!-- --></a>
<div class="oddrow">

	<div class="var-header">
		<span class="var-title">
			<span class="var-type">bool</span>
			<span class="var-name">$createAccount</span>
	...
	<!-- ========== Info from phpDoc block ========= -->
	<ul class="tags">
				<li><span class="field">var:</span> Whether to create a default account</li>
...
<div class="evenrow">
	...
	<!-- ========== Info from phpDoc block ========= -->
	<ul class="tags">
				<li><span class="field">var:</span> Whether to update template files</li>
				<li><span class="field">access:</span> public</li>
			</ul>
...
<div class="oddrow">
	...
	<!-- ========== Info from phpDoc block ========= -->
	<ul class="tags">
				<li><span class="field">var:</span> Whether to create/update index.php file</li>
				<li><span class="field">access:</span> public</li>
			</ul>
...
<div class="evenrow">
	...
	<!-- ========== Info from phpDoc block ========= -->
	<ul class="tags">
				<li><span class="field">var:</span> Datasource mysql://events:events@localhost/events</li>
				<li><span class="field">access:</span> public</li>
			</ul>
...
<div class="oddrow">
	...
	<div class="method-header">
		<span class="method-title">createAccount</span> (line <span class="line-number">133</span>)
	</div> 
	
	<!-- ========== Info from phpDoc block ========= -->
<p class="short-description">This function will create a calendar account if it  does not already exist.</p>
	...
	<div class="method-signature">
		...
		<span class="method-name">
			...
			<ul class="parameters">
				...
				<span class="var-name">$answers</span><span class="var-description">: Responses from the user.</span>			</li>
				</ul>
...
<div class="evenrow">
	...
	<div class="method-header">
		<span class="method-title">createFiles</span> (line <span class="line-number">159</span>)
	</div> 
...
<div class="oddrow">
	...
	<div class="method-header">
		<span class="method-title">dircpy</span> (line <span class="line-number">236</span>)
	</div> 
...
<div class="evenrow">
	...
	<div class="method-header">
		<span class="method-title">file_str_replace</span> (line <span class="line-number">193</span>)
	</div> 
...
<div class="oddrow">
	...
	<div class="method-header">
		<span class="method-title">init</span> (line <span class="line-number">57</span>)
	</div> 
...
<div class="evenrow">
	...
	<div class="method-header">
		<span class="method-title">outputData</span> (line <span class="line-number">273</span>)
	</div> 
	...
	<div class="method-signature">
		...
		<span class="method-name">
			...
			<ul class="parameters">
					<li>
				<span class="var-type">string</span>
				<span class="var-name">$msg</span><span class="var-description">: Message to send</span>			</li>
				</ul>
...
<div class="oddrow">
	...
	<div class="method-header">
		<span class="method-title">postProcessPrompts</span> (line <span class="line-number">76</span>)
	</div> 
...
<div class="evenrow">
	...
	<div class="method-header">
		<span class="method-title">run</span> (line <span class="line-number">93</span>)
	</div> 
