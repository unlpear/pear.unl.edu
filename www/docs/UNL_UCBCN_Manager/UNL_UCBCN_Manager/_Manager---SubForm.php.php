...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN_Manager | Docs for page SubForm.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/Manager/SubForm.php</h2>
...
<p class="short-description">This file extends the subform class to override the toHTML issue.</p>
<div class="description"><p>PHP version 5</p></div>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_UCBCN_Manager/UNL_UCBCN_Manager_SubForm.php">UNL_UCBCN_Manager_SubForm</a>
					</td>
					<td>
	...
	<div>
		<span class="include-title">
			...
			(<span class="include-name">'DB/DataObject/FormBuilder/QuickForm/SubForm.php'</span>)
