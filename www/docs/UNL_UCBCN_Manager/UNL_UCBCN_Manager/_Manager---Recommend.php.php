...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN_Manager | Docs for page Recommend.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/Manager/Recommend.php</h2>
...
<p class="short-description">This file handles recommendations for other calendars.</p>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_UCBCN_Manager/UNL_UCBCN_Manager_Recommend.php">UNL_UCBCN_Manager_Recommend</a>
					</td>
					<td>
