...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN_Manager | Docs for page UNL_UCBCN_Manager_setup.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/UNL_UCBCN_Manager_setup.php</h2>
...
<p class="short-description">PEAR postinstall script for the management portion of the calendar system.</p>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_UCBCN_Manager/UNL_UCBCN_Manager_setup_postinstall.php">UNL_UCBCN_Manager_setup_postinstall</a>
					</td>
					<td>
