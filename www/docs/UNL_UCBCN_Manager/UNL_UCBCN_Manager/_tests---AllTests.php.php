...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN_Manager | Docs for page AllTests.php</title>";
$p->breadcrumbs = '<ul>
...
<p class="short-description">Test suite for UNL_UCBCN_Manager</p>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_UCBCN_Manager/UNL_UCBCN_Manager_AllTests.php">UNL_UCBCN_Manager_AllTests</a>
					</td>
					<td>
...
<div class="evenrow">
	...
	<div>
		<span class="include-title">
			<span class="include-type">require_once</span>
			(<span class="include-name">dirname(__FILE__).'/CreateEventTest.php'</span>)
...
<div class="oddrow">
	...
	<div>
		<span class="include-title">
			<span class="include-type">require_once</span>
			(<span class="include-name">dirname(__FILE__).'/EventActionsTest.php'</span>)
...
<div class="evenrow">
	...
	<div>
		<span class="include-title">
			<span class="include-type">require_once</span>
			(<span class="include-name">dirname(__FILE__).'/UNL/UCBCN/ManagerTest.php'</span>)
...
<div class="oddrow">
	...
	<div>
		<span class="const-title">
			<span class="const-name">PHPUnit_MAIN_METHOD</span> = 'UNL_UCBCN_Manager_AllTests::main'
