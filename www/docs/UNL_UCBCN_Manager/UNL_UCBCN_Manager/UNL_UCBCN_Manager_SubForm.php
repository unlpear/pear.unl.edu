...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_UCBCN_Manager | Docs For Class UNL_UCBCN_Manager_SubForm</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="class-name">Class UNL_UCBCN_Manager_SubForm</h2>
...
<p class="short-description">Makes subforms use the correct renderer and do some minor manupulations.</p>
	<ul class="tags">
		...
		<p class="notes">
			Located in <a class="field" href="_UNL---UCBCN---Manager---SubForm.php.php">/UNL/UCBCN/Manager/SubForm.php</a> (line <span class="field">26</span>)
		</p>
		
				
		<pre>HTML_QuickForm_SubForm
   |
   --UNL_UCBCN_Manager_SubForm</pre>
...
<div class="oddrow">
	...
	<div class="method-header">
		<span class="method-title">toHtml</span> (line <span class="line-number">34</span>)
	</div> 
	
	<!-- ========== Info from phpDoc block ========= -->
<p class="short-description">renders the element</p>
	<ul class="tags">
				<li><span class="field">return:</span> the HTML for the element</li>
