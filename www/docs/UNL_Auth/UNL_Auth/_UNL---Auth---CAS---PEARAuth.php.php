...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_Auth | Docs for page PEARAuth.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/UNL/Auth/CAS/PEARAuth.php</h2>
...
<p class="short-description">PEAR Auth compatible container for CAS</p>
<div class="description"><p>PHP version 5</p></div>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_Auth/UNL_Auth_CAS_PEARAuth.php">UNL_Auth_CAS_PEARAuth</a>
					</td>
					<td>
	...
	<div>
		<span class="include-title">
			...
			(<span class="include-name">'Auth/Container.php'</span>)
...
<div class="evenrow">
	...
	<div>
		<span class="include-title">
			...
			(<span class="include-name"><a href="../UNL_Auth/_UNL---Auth---CAS.php.php">'UNL/Auth/CAS.php'</a></span>)
