...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_Auth | Docs for page CAS.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/UNL/Auth/CAS.php</h2>
...
<p class="short-description">This is a CAS central authentication.</p>
<div class="description"><p>DO NOT MODIFY THIS FILE.  This file remains part of the UNL Login public API and is subject to change.  If you require features built into this class, please contact us by email at  &lt;accounts@answers4families.org&gt;.</p><p>based on the Answers4Families [http://www.answers4families.org/] Account Services  LDAP-CAS API.</p><p>PHP version 5</p></div>
	<ul class="tags">
				<li><span class="field">author:</span> Brett Bieber &lt;<a href="mailto:brett.bieber@gmail.com">brett.bieber@gmail.com</a>&gt;</li>
				<li><span class="field">author:</span> Ryan Lim &lt;<a href="mailto:rlim@ccfl.unl.edu">rlim@ccfl.unl.edu</a>&gt;</li>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_Auth/UNL_Auth_CAS.php">UNL_Auth_CAS</a>
					</td>
					<td>
											UNL_Auth_CAS
										</td>
	...
	<div>
		<span class="include-title">
			...
			(<span class="include-name"><a href="../UNL_Auth/_UNL---Auth---CAS.php.php">'CAS.php'</a></span>)
