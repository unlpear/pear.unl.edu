...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_Auth | Docs For Class UNL_Auth_SimpleCAS</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="class-name">Class UNL_Auth_SimpleCAS</h2>
...
<p class="short-description">UNL_Auth_SimpleCAS</p>
<div class="description"><p>This is the CAS UserAccount class.  This class takes care of user authentication using CAS and obtains the user  account information via LDAP.</p><p>This class does not handle changes to the user account information. All account  information changes are handled by http://login.unl.edu/</p></div>
	<ul class="tags">
		...
		<p class="notes">
			Located in <a class="field" href="_UNL---Auth---SimpleCAS.php.php">/UNL/Auth/SimpleCAS.php</a> (line <span class="field">29</span>)
		</p>
		
				
		<pre><a href="../UNL_Auth/UNL_Auth.php">UNL_Auth</a>
   |
   --UNL_Auth_SimpleCAS</pre>
	...
	<div class="info-box">
		...
		<div class="info-box-body">
			<div class="var-summary">
					...
					<a href="#var_client" title="details" class="var-name">$client</a>
				</div>
																<div class="var-title">
	...
	<div class="info-box">
		...
		<div class="info-box-body">			
			<div class="method-summary">
					...
					static 						<span class="method-result"><a href="../UNL_Auth/UNL_Auth_SimpleCAS.php">UNL_Auth_SimpleCAS</a></span>
	...
	<div class="info-box">
		...
		<div class="info-box-body">
			<a name="var_client" id="var_client"><!-- --></a>
<div class="oddrow">
	...
	<div class="var-header">
		<span class="var-title">
			...
			<span class="var-name">$options</span>
			 = <span class="var-default">array('hostname' =&gt; 'login.unl.edu',<br />                               'port'     =&gt; 443,<br />                               'uri'      =&gt; 'cas')</span>			(line <span class="line-number">50</span>)
		</span>
	</div>
...
<p class="short-description">get a singleton instance of this class</p>
	...
	<div class="method-signature">
	    static
		<span class="method-result"><a href="../UNL_Auth/UNL_Auth_SimpleCAS.php">UNL_Auth_SimpleCAS</a></span>
...
<div class="evenrow">
	...
	<div class="method-header">
		<span class="method-title">getUser</span> (line <span class="line-number">92</span>)
	</div> 
...
<div class="oddrow">
	...
	<div class="method-header">
		<span class="method-title">isLoggedIn</span> (line <span class="line-number">87</span>)
	</div> 
...
<div class="evenrow">
	...
	<div class="method-header">
		<span class="method-title">login</span> (line <span class="line-number">97</span>)
	</div> 
...
<div class="oddrow">
	...
	<div class="method-header">
		<span class="method-title">logout</span> (line <span class="line-number">102</span>)
	</div> 
