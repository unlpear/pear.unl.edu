...
$p->doctitle = "<title>UNL | pear.unl.edu | UNL_Auth | Docs for page SimpleCAS.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/UNL/Auth/SimpleCAS.php</h2>
...
<div class="description"><p>PHP version 5</p></div>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../UNL_Auth/UNL_Auth_SimpleCAS.php">UNL_Auth_SimpleCAS</a>
					</td>
					<td>
											UNL_Auth_SimpleCAS
										</td>
	...
	<div>
		<span class="include-title">
			...
			(<span class="include-name">'SimpleCAS/Autoload.php'</span>)
...
<div class="oddrow">
	...
	<div>
		<span class="include-title">
			<span class="include-type">require_once</span>
			(<span class="include-name">'HTTP/Request2.php'</span>)
