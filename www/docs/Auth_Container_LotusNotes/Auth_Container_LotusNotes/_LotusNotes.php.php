...
$p->doctitle = "<title>UNL | pear.unl.edu | Auth_Container_LotusNotes | Docs for page LotusNotes.php</title>";
$p->breadcrumbs = '<ul>
...
?>
			<div class="page-body">			
<h2 class="file-name">/LotusNotes.php</h2>
...
<p class="short-description">This PEAR Auth container is intended for authentication against a  Lotus Notes LDAP directory.</p>
<div class="description"><p>This is the PEAR Auth LDAP container Modified by Brett Bieber:  changed PEAR_ERROR_DIE to PEAR_ERROR_RETURN for graceful exits on bind errors</p></div>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				<tr>
					...
					<td style="padding-right: 2em; vertical-align: top">
						<a href="../Auth_Container_LotusNotes/Auth_Container_LotusNotes.php">Auth_Container_LotusNotes</a>
					</td>
					<td>
	...
	<div>
		<span class="include-title">
			...
			(<span class="include-name">'Auth/Container/LDAP.php'</span>)
